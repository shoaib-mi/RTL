...
var line: string
line = "با سلام خدمت دوست گرامی جناب آقای شعیب میرزایی امیدوارم حالتون خوب باشه"
doc.drawText(15, 50, str2uni(line))
line = "این نوشته در تاریخ 25 ژوئن 2023 نوشته شده است"
doc.drawText(15, 150, str2uni(line))

if not doc.writePDF(r"D:\Shoaib\Codes\nim\hello.pdf"):
